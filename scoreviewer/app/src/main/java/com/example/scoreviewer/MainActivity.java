...
import com.example.scoreviewer.ActivityHelper;
import com.example.scoreviewer.R;
import com.example.scoreviewer.ble.BleUtils;
import com.example.scoreviewer.ble.central.BleManager;
import com.example.scoreviewer.ble.central.BlePeripheral;
import com.example.scoreviewer.dfu.DfuProgressFragmentDialog;
import com.example.scoreviewer.dfu.DfuService;
import com.example.scoreviewer.dfu.DfuUpdater;
import com.example.scoreviewer.dfu.ReleasesParser;
import com.example.scoreviewer.models.DfuViewModel;
...
public class MainActivity extends AppCompatActivity implements ScannerFragment.ScannerFragmentListener, PeripheralModulesFragment.PeripheralModulesFragmentListener, DfuProgressFragmentDialog.Listener, Controlling.ControllingListener {
    ...
    protected void onResume() {
        ...
        ActivityHelper.activityResumed();
        checkPermissions();
    ...
    public void startPeripheralModules(String peripheralIdentifier) {
        Controlling fragment = Controlling.newInstance(peripheralIdentifier);
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction()
                .setCustomAnimations(R.anim.slide_in_left, R.anim.slide_out_right, R.anim.slide_in_right, R.anim.slide_out_left)
