...
public class Volleyball extends Fragment{
    private static final String TAG = Volleyball.class.getSimpleName();
    ...
    private Volleyball.VolleyballListener mListener;
    ...
    public static Volleyball newInstance(Communications _mCommunications) {
        Volleyball fragment = new Volleyball(_mCommunications);
        return fragment;
    }

    public Volleyball(Communications _mCommunications) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)  {
        ...
        if (activity != null) {
            ...
            if (actionBar != null) {
                actionBar.setTitle(R.string.gamevolleyball);
                actionBar.setDisplayHomeAsUpEnabled(true);
            }
        }

        Plus1T1=view.findViewById(R.id.VB_Plus1Team1);
        Sub1T1=view.findViewById(R.id.VB_Sub1Team1);

        Plus1T2=view.findViewById(R.id.VB_Plus1Team2);
        Sub1T2=view.findViewById(R.id.VB_Sub1Team2);


        ResetScores=view.findViewById(R.id.VB_resetscores);

        mT1ScoreView=view.findViewById(R.id.Team1ScoreVB);
        mT2ScoreView=view.findViewById(R.id.Team2ScoreVB);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof Volleyball.VolleyballListener) {
            mListener = (Volleyball.VolleyballListener) context;
        } else if (getTargetFragment() instanceof Volleyball.VolleyballListener) {
            mListener = (Volleyball.VolleyballListener) getTargetFragment();
        } else {
